...
public:
    ...
    // removing operators
    PCM_ParticipantData(const PCM_ParticipantData &) = delete;
    PCM_ParticipantData(PCM_ParticipantData &&) = delete;
    PCM_ParticipantData &operator=(const PCM_ParticipantData &) = delete;
    PCM_ParticipantData &operator=(PCM_ParticipantData &&) = delete;
