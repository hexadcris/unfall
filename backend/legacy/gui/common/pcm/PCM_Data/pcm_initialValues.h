...
public:
    ...
    // removing operators
    PCM_InitialValues(const PCM_InitialValues &) = delete;
    PCM_InitialValues(PCM_InitialValues &&) = delete;
    PCM_InitialValues &operator=(const PCM_InitialValues &) = delete;
    PCM_InitialValues &operator=(PCM_InitialValues &&) = delete;
