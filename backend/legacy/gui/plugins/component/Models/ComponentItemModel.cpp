...
ComponentItemModel::ComponentItemModel(QObject *const parent) :
    ComponentItemInterface(parent), type(DefaultType), title(DefaultTitle), schedule(new ComponentScheduleModel(this)), parameters(new ComponentParameterMapModel(this)), inputs(new ComponentInputMapModel(this)), outputs(new ComponentOutputMapModel(this))
{
}
