...
SystemComponentItemModel::SystemComponentItemModel(ComponentItemInterface const *const component,
    ...
    SystemComponentItemInterface(parent), component(component), title(component->getTitle()), schedule(new SystemComponentScheduleModel(component->getSchedule(), this)), parameters(new SystemComponentParameterMapModel(component->getParameters(), this)), inputs(new SystemComponentInputMapModel(component->getInputs(), this)), outputs(new SystemComponentOutputMapModel(component->getOutputs(), this)), position(position)
{
}
