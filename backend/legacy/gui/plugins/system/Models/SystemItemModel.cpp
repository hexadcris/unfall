...
SystemItemModel::SystemItemModel(QObject *const parent) :
    SystemItemInterface(parent), title(SystemItemInterface::Title(QStringLiteral(""))), priority(0), connections(new SystemConnectionMapModel(this)), components(new SystemComponentMapModel(connections, this))
{
}
