...
SystemComponentParameterValueIntView::SystemComponentParameterValueIntView(SystemComponentParameterItemInterface *const parameter,
    ...
    SpinBoxView(parent), parameter(parameter)
{
    setMinimumSize(0, 20);
    ...
    connect(this, static_cast<void (SystemComponentParameterValueIntView::*)(int)>(&SystemComponentParameterValueIntView::valueChanged),
