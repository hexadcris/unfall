...
SystemComponentParameterValueDoubleView::SystemComponentParameterValueDoubleView(SystemComponentParameterItemInterface *const parameter,
    ...
    DoubleSpinBoxView(parent), parameter(parameter)
{
    setMinimumSize(0, 20);
    ...
    connect(this, static_cast<void (SystemComponentParameterValueDoubleView::*)(double)>(&SystemComponentParameterValueDoubleView::valueChanged),
