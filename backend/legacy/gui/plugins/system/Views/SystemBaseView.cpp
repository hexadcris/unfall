...
SystemBaseView::SystemBaseView(SystemItemInterface *const system,
    ...
    QWidget(parent), system(system), componentsModifyMode(false), connectionsModifyMode(false), inputActive(nullptr), inputConnection(nullptr), outputActive(nullptr), outputConnection(nullptr), internalConnectionsCurveMap({{false, {}}, {true, {}}})
{
