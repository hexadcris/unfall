...
public:
    ...
    //-----------------------------------------------------------------------------
    virtual void OpSimulationManagerPreHook() {}
    ...
    //-----------------------------------------------------------------------------
    virtual void OpSimulationManagerPostHook(const std::string &filename)
    {
        Q_UNUSED(filename)
    }

    virtual void Op_SimulationPreHook(const std::string &path);

    //-----------------------------------------------------------------------------
    //! Called by framework in smulation before each simulation run starts.
    //-----------------------------------------------------------------------------
    virtual void Op_SimulationPreRunHook();
    ...
    //-----------------------------------------------------------------------------
    virtual void Op_SimulationUpdateHook(int time, RunResultInterface &runResult);
    ...
    //-----------------------------------------------------------------------------
    virtual void Op_SimulationPostRunHook(const RunResultInterface &runResult);

    //-----------------------------------------------------------------------------
    //! Called by framework in simulation after all simulation runs end.
    //-----------------------------------------------------------------------------
    virtual void Op_SimulationPostHook();
    ...
    //-----------------------------------------------------------------------------
    virtual const std::string Op_SimulationResultFile()
    {
        return "";   //dummy
    }
