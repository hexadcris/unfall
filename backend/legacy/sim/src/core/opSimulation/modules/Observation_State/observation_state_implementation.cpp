...
void Observation_State_Implementation::Op_SimulationPreHook(const std::string &path)
{
    Q_UNUSED(path);
...
void Observation_State_Implementation::Op_SimulationPreRunHook()
{
    timeChannel.clear();
    channels.clear();
...
void Observation_State_Implementation::Op_SimulationUpdateHook(int time, RunResultInterface &runResult)
{
    Q_UNUSED(runResult);
...
void Observation_State_Implementation::Op_SimulationPostRunHook(const RunResultInterface &runResult)
{
    Q_UNUSED(runResult);
...
void Observation_State_Implementation::Op_SimulationPostHook()
{
