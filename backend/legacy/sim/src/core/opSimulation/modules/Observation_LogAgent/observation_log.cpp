...
//-----------------------------------------------------------------------------
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT const std::string& OpenPASS_GetVersion()
{
    return Version;
}
...
//-----------------------------------------------------------------------------
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT ObservationInterface* OpenPASS_CreateInstance(
...
//-----------------------------------------------------------------------------
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT void OpenPASS_DestroyInstance(ObservationInterface* implementation)
{
    delete implementation;
}

extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationManagerPreHook(ObservationInterface* implementation)
{
    try
    {
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationManagerPostHook(ObservationInterface* implementation,
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationPreHook(ObservationInterface* implementation)
{
    try
    {
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationPreRunHook(ObservationInterface* implementation)
{
    try
    {
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationUpdateHook(ObservationInterface* implementation,
        int time,
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationPostRunHook(ObservationInterface* implementation,
...
extern "C" OBSERVATION_LOGAGENT_SHARED_EXPORT bool OpenPASS_OpSimulationPostHook(ObservationInterface* implementation)
{
    try
    {
