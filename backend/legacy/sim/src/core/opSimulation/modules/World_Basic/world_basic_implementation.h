...
public:
    ...
    virtual void *GetGlobalDrivingView() const
    {
        return nullptr;   //dummy
    }

    virtual void *GetGlobalObjects() const
    {
        return nullptr;   //dummy
    }
    ...
    const AgentInterface *GetSpecialAgent() const
    {
        return nullptr;   //dummy
    }

    const AgentInterface *GetLastCarInlane(int laneNumber) const
    {
        Q_UNUSED(laneNumber);
        return nullptr;
    } //dummy
