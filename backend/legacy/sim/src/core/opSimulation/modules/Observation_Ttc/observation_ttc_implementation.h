...
public:
    ...
    virtual void OpSimulationPreHook(const std::string &path);

    //-----------------------------------------------------------------------------
    //! Called by framework in simulation before each simulation run starts.
    //-----------------------------------------------------------------------------
    virtual void OpSimulationPreRunHook();
    ...
    //-----------------------------------------------------------------------------
    virtual void OpSimulationUpdateHook(int time, RunResultInterface &runResult);
    ...
    //-----------------------------------------------------------------------------
    virtual void OpSimulationPostRunHook(const RunResultInterface &runResult);

    //-----------------------------------------------------------------------------
    //! Called by framework in simulation after all simulation runs end.
    //-----------------------------------------------------------------------------

    virtual void OpSimulationPostHook();
    ...
    virtual const std::string OpSimulationResultFile()
    {
        return "";   //dummy
    }
