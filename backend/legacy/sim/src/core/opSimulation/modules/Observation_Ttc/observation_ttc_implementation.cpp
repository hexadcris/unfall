...
void Observation_Ttc_Implementation::OpSimulationPreHook(const std::string &path)
{
    Q_UNUSED(path);
...
void Observation_Ttc_Implementation::OpSimulationPreRunHook()
{
    agentsMinTtc.clear();
    agentsTtc.clear();
    timeVector.clear();
...
//--------------------- update in run ----------------------------//
void Observation_Ttc_Implementation::OpSimulationUpdateHook(int time, RunResultInterface &runResult)
{
    Q_UNUSED(runResult);
...
void Observation_Ttc_Implementation::OpSimulationPostRunHook(const RunResultInterface &runResult)
{
    Q_UNUSED(runResult);
...
void Observation_Ttc_Implementation::OpSimulationPostHook()
{
