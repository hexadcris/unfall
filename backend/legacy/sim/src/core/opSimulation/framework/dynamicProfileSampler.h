...
struct SampledProfiles
{
     ...
     */
    static DynamicProfileSampler make(std::string agentProfileName, StochasticsInterface& stochastics, const ProfilesInterface* profiles);
...
{
public:
    DynamicProfileSampler(std::string agentProfileName, StochasticsInterface& stochastics, const ProfilesInterface* profiles) :
