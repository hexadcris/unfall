...
void UT_Dynamics2TMTest::testCase1_data()
{
    ...
    QTest::addColumn<double>("F_max"); //mu_max
    QTest::addColumn<double>("F_slide"); //mu_slide
    ...
    QTest::newRow("NULL") << 1000.0 // forceTireVerticalStatic
                          << 1.0 // mu_max
                          << 0.5 // mu_slide
                          << 0.1 // s_max
                          << 0.2 // r_tire
...
QTEST_MAIN(UT_Dynamics2TMTest);

#include "tst_ut_dynamics2tmtest.moc"
